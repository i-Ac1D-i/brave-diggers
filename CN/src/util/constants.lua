...
--返回channel_constants，constants作为前者的元表进行访问，形如默认值。
--constants中为大陆使用的值，各渠道不同的值定义在channel_constants中，以覆盖constants
...
if platform_manager:GetChannelInfo().region == "r2games" then
    --最大区域数量
    channel_constants["MAX_AREA_NUM"] = 50

    --签到时间
    channel_constants["CHECKIN_TIME"] =
    {
        ["first"] = 8,
        ["second"] = 16,
        ["third"] = 24,
    ...
    --矿区的地下探险购买价格
    channel_constants["CAVE_DAILY_BUY_PRICE"] =  {
        [1] = {20,40,60,80},
        [2] = {20,40,60,80},
        [3] = {20,40,60,80},
        [4] = {20,40,60,80},
    ...
    --矿区的地下探险购买次数
    channel_constants["CAVE_DAILY_BUY_CHALLENGE_NUM"] = {
        [1] = 4,
        [2] = 4,
        [3] = 4,
        [4] = 4,
    ...
    channel_constants["DAILY_TAG"] =
    {
        ...
        ["arena_first_four"] = 7, --每日首次4胜
        ["arena_first_nine"] = 8, --每日首次9胜
        ["carnival"] = 9,   --每日登陆送血钻
        ["quest_random_mail"] = 10, --每日随机邮件
    }
    
    --成就类型
    channel_constants["ACHIEVEMENT_TYPE"] =
    {
        ...
        ["recharge_bd_without_gift"] = 57,--充值血钻收益去除赠送的
        ["rune_quality1"] = 58, --获得符文数（品质1）
        ["rune_quality2"] = 59, --获得符文数（品质2）
        ["rune_quality3"] = 60, --获得符文数（品质3）
        ["rune_quality4"] = 61, --获得符文数（品质4）
        ["rune_quality5"] = 62, --获得符文数（品质5）
        ["rune_quality6"] = 63, --获得符文数（品质6）
        ["crystal_consume"] = 64,   --消耗符文水晶
        ["crystal"] = 65,           --获得符文水晶
        ["escort_rob"] = 66, --矿车拦截目标
        ["mining_occupancy"] = 67, --随机事件 占领
        ["mining_resource"] = 68,--随机事件 随机获得或失去资源
        ["mining_treasure_hunt"] = 69,--随机事件 寻宝
        ["mining_random_event_count"] = 70,--随机事件 总次数
        ["guild_boss_atk_times"] = 71,
        ["destiny_weapon_star"] = 72,
        ["destiny_num"] = 73,     --宿命武器数量
    }
    
    --转生血钻消耗
    channel_constants["TRANSMIGRATION_COST"] = {
        [1] = 0,
        [2] = 0,
        [3] = 0,
        [4] = 0,
...
elseif platform_manager:GetChannelInfo().region == "qikujp" then
    --最大区域数量
    channel_constants["MAX_AREA_NUM"] = 45
elseif platform_manager:GetChannelInfo().region == "txwy_dny" then
    ...
    --招募消耗
    channel_constants["RECRUIT_COST"] = {
        ["ten_mercenary_door"] = 500,  --消耗血钻
    ...
    --最大区域数量
    channel_constants["MAX_AREA_NUM"] = 66
    ...
    channel_constants["ACHIEVEMENT_TYPE"] =
    {
        ...
        ["destiny_weapon_star"] = 72,
        ["destiny_num"] = 73,     --宿命武器数量
        ["rune_quality4_max_level"] = 74,       --满级紫色符文数量
        ["rune_quality5_max_level"] = 75,       --满级金色符文数量
        ["rune_quality6_max_level"] = 76,       --满级闪金符文数量
    }

    --随机刷新矿车消耗
    channel_constants["ESCORT_REFRESH_TRAMCAR_RANDOM_COST"] = 50
...
elseif platform_manager:GetChannelInfo().region == "txwy" then
    ...
    channel_constants["ACHIEVEMENT_TYPE"] =
    {
        ...
        ["mining_occupancy"] = 66, --随机事件 占领
        ["mining_resource"] = 67,--随机事件 随机获得或失去资源
        ["mining_treasure_hunt"] = 68,--随机事件 寻宝
        ["mining_random_event_count"] = 69,--随机事件 总次数
        ["guild_boss_atk_times"] = 70,
        ["recharge_bd_without_gift"] = 71,--充值血钻收益去除赠送的
        ["destiny_weapon_star"] = 72,
        ["destiny_num"] = 73,     --宿命武器数量
        ["rune_quality4_max_level"] = 74,       --满级紫色符文数量
        ["rune_quality5_max_level"] = 75,       --满级金色符文数量
    ...
    --随机刷新矿车消耗
    channel_constants["ESCORT_REFRESH_TRAMCAR_RANDOM_COST"] = 80
    ...
    --解锁矿山消耗
    channel_constants["MINE_UNLOCK_COST"] = {
        [1] = {},
        [2] = {"soul_chip", -6000,},
        [3] = {"blood_diamond", -1000,},
    }
    --解锁矿山消耗
    channel_constants["MINE_UNLOCK_COST"] = {
        [1] = {},
...
local constants = {}
setmetatable(channel_constants, { __index = constants })
...
constants["RESOURCE_TYPE"] =
{
    ...
    ["guild_boss_ticket"] = 51,         --公会boss进入门票
    ["guild_boss_contribution"] = 52,   --公会boss贡献

    ["guild_war_point"] = 53, --工会战积分

    ["crystal"] = 54,       --水晶
    ["crystal_bag"] = 55,   --水晶包

    ["forge_ticket"] = 56,      --宝具锻造券
    
    ["senior_soul_crystal1"] = 57,
    ["senior_soul_crystal2"] = 58,
    ...
    ["fatecrystal"]  = 92,
    ["share_integral"] = 93,
    ["vanity_adventure"] = 94,      --虚空冒险积分
    ["purple_soul"]  = 95,          --紫色灵魂碎片
    ["gold_soul"]  = 96,            --金色灵魂碎片
    ["flash_gold_soul"]  = 97,      --闪金灵魂碎片
}

constants["RESOURCE_TYPE_NAME"] = {}
for k, v in pairs(channel_constants["RESOURCE_TYPE"]) do
...
constants["ACHIEVEMENT_TYPE"] =
{
    ...
    ["rune_quality5_max_level"] = 75,       --满级金色符文数量
    ["rune_quality6_max_level"] = 76,       --满级闪金符文数量
    ["new_open_chest"] = 77, --打开矿区宝箱次数,新的记录,不在原来的基础上累加
}

constants["ACHIEVEMENT_TYPE_NAME"] = {}
for k, v in pairs(channel_constants["ACHIEVEMENT_TYPE"]) do
    constants["ACHIEVEMENT_TYPE_NAME"][v] = k
end

constants["RUNE_QUALITY_TO_ACHIEVE"] = 
{
    [4] = "rune_quality4_max_level",
    [5] = "rune_quality5_max_level",
    [6] = "rune_quality6_max_level"
}

--经验符文排除在成就之外
constants["RUNE_ACHIEVE_EXTRA"] = 
{ 
    [1] = true,[2] = true,[3]=true,[76]=true,[77]=true
}
...
for k, v in pairs(channel_constants["PROPERTY_TYPE"]) do
    constants["PROPERTY_TYPE_NAME"][v] = k
end

constants["MERCENARY_GENRE_NUM"] = 4
...
constants["BLOCK_TYPE"] =
{
    ...
    ["harder_rock"] = 47,
    ["chest7"] = 48, --节日限定宝箱
    ["random_occupancy"] = 49, --随机事件 占领
    ["random_resource"] = 50, --随机事件 随机获得或失去资源
    ["random_treasure_hunt"] = 51,--随机事件 寻宝
    ["tree_in_depth"] = 52, --地心古树
    ["fallen_griffin"] = 53, --堕落狮鹫
    ["medusa_queen"] = 54,--美杜莎女王
}

local BLOCK_TYPE = channel_constants["BLOCK_TYPE"]
constants["MINING_BOSS_MAP"] = {
    ...
    [BLOCK_TYPE["tree_in_depth"]] = 440, --地心古树
    [BLOCK_TYPE["fallen_griffin"]] = 460, --堕落狮鹫
    [BLOCK_TYPE["medusa_queen"]] = 480, --美杜莎女王
}

--随机事件类型
constants["RANDOM_EVENT_TYPE"] =
{  
    ["occupancy"] = 1,      --占领
    ["resource"] = 2,       --比大小
    ["treasure_hunt"] = 3,  --寻宝
...
constants["CHEST_BLOCK_MAP"] = 
{
    [BLOCK_TYPE["chest1"]] = true,
    [BLOCK_TYPE["chest2"]] = true,
    [BLOCK_TYPE["chest3"]] = true,
    [BLOCK_TYPE["chest4"]] = true,
    [BLOCK_TYPE["chest5"]] = true,
    [BLOCK_TYPE["chest6"]] = true,
    [BLOCK_TYPE["chest7"]] = true,
}

constants["CONVERT_NET"] = 
{
    ["none"] = -1,
    ["wifi"]=1,
    ["2G"]=2,
...
constants["QUARRY_BOSS_ITERATE"] = {
    ...
    [BLOCK_TYPE["seven_doom"]] = BLOCK_TYPE["tree_in_depth"],
    [BLOCK_TYPE["tree_in_depth"]] = BLOCK_TYPE["fallen_griffin"],
    [BLOCK_TYPE["fallen_griffin"]] = BLOCK_TYPE["medusa_queen"],
    [BLOCK_TYPE["medusa_queen"]] = 0,--最后一个BOSS

}

local RESOURCE_TYPE = channel_constants["RESOURCE_TYPE"]
...
--商会重置消耗
constants["MERCHANT_RESET_COST"] = 40
...
constants["MERCHANT_WHITE_FIXED_PRICE"] = 40
...
constants["REWARD_SOURCE"] =
{
    ...
    ["fund"] = 62,
    ["guild_war_buff"] = 63,
    ["guild_war_exchange"] = 64,    --公会战兑换
    ["guild_war_settlement"] = 65,  --公会战结算
    ["draw_rune"] = 66,             --抽符文
    ["buy_rune_bag"] = 67,          --购买符文背包
    ["escort_buy_rob_times"] = 68,              --护送：购买拦截次数
    ["escort_buy_escort_times"] = 69,           --护送：购买护送次数
    ["escort_refresh_tramcar"] = 70,            --护送：刷新矿车
    ["escort_refresh_rob_target_list"] = 71,    --护送：立即刷新可拦截目标
    ["escort_rob_success"] = 72,                --护送：拦截成功后奖励
    ["escort_finish"] = 73,                     --护送：护送完成后奖励
    ["mining_random_event"] = 74,       --进行随机事件 
    ["mining_random_event_finish"] = 75, --完成随机事件
    ["guild_boss_exchange"] = 76,
    ["guild_boss_challenge"] = 77,
    ["guild_boss_chests"] = 78,
    ["liveness_reward"] = 79,
    ["sns_share"] = 80,
    ["buy_adventure_event"] = 81,
    ["magic_shop"] = 82,
}
...
--技能修炼路线
constants["SKILL_CULTIVATION"] =
{
    ["critical_damage"]                 = 1, 
    ["increase_damage"]                 = 2, 
    ["rage_damage"]                     = 4, 
    ["damage_by_enemy_bp"]              = 3, 
    ["damage_by_enemy_init_bp"]         = 3, 
    ["damage_by_enemy_loss_bp"]         = 4, 
    ["bp_steal"]                        = 2, 
    ["increase_by_self_bp"]             = 6, 
    ["increase_by_self_init_bp"]        = 6, 
    ["increase_by_enemy_bp"]            = 6, 
    ["increase_by_enemy_init_bp"]       = 6, 
    ["true_damage"]                     = 5,           
}
...
constants["MINING_EVENT_TYPE_ID"] =
{
    ...
    ["seven_doom"] = 4000011,
    ["tree_in_depth"] = 4000012, 
    ["fallen_griffin"] = 4000013,
    ["medusa_queen"] = 4000014,
}
...
constants["GUILD_WAR_TROOP_ID"] = 32
constants["KF_PVP_TROOP_ID"] = 31
constants["MINE_TROOP_ID"] = {10,11,12}
constants["ALL_FORMATIONS"] = {1,2,3,4,5,10,11,12,31,32}
...
--开启宝具消耗资源数目
constants["OPEN_ARTIFACT_CONSUME_RESOURCE_1"] = {
    ["gold_coin"] = 95000000,
    ["red_soul_crystal"] = 6,
...
constants["OPEN_ARTIFACT_CONSUME_RESOURCE_2"] = {
    ["forge_ticket"] = 1,
}
...
for k, v in pairs(channel_constants["VIP_TYPE"]) do
...
constants["CARNIVAL_TYPE"] =
{
    ...
    ["sns_invitation"] = 16,
    ["limite_package"] = 17,
    ["mercenary_exchange"] = 18,
    ["limite_pacakge_blood"] = 19
}
...
constants["FORMATION_NAME_LENGTH"] = 8
...
constants["GUILD_JOIN_THRESHOLD"] = {
    0,500000,2000000,3000000,5000000
}
...
constants["FORGE_WEAPON_LUCKY_NUM"] = 5

constants["GUILDWAR_ROUND"] = 8
constants["GUILDWAR_STATUS"] = {
    ["NONE"] = 0,           --休战
    ["READY"] = 1,          --准备
    ["WAIT_ENTER"] = 2,     --报名
    ["WAIT_TROOP"] = 3,     --上阵
...
constants["GUILDWAR_RANDOM_MATCH_TIER"] = 4
constants["GUILDWAR_USER_MAX_BATTLE_TIMES"] = 5
constants["GUILDWAR_SORT_POINT_DOWN_LIMIT"] = 85
constants["GUILDWAR_SORT_POINT_UP_LIMIT"] = 115

constants["GUILDWAR_SCORE_TIER_MAP"]= {
    [1] = 3300,
    [2] = 2850,
    [3] = 2400,
    [4] = 2100,
...
constants["MAX_WAR_FIELDS"] = 3

constants["GUILDWAR_BASE_SCORE"] = {70,50,40,30,25,20,15}
constants["GUILDWAR_ROUND_SCORE"] = {280,200,160,120,100,80,60}
constants["GUILDWAR_FIELD_SCORE"] = {70,50,40,30,25,20,15}
constants["GUILDWAR_KILL_SCORE"] = {70,50,40,30,25,20,15}

constants["GUILDWAR_BUFF_TYPE"] =
{
    ["bp"] = 1,
    ["speed"] = 2,
    ["defense"] = 3,
...
local GUILDWAR_BUFF_TYPE = channel_constants["GUILDWAR_BUFF_TYPE"]
constants["GUILDWAR_BUFF_COST"] =
{
    [GUILDWAR_BUFF_TYPE["bp"]] = 50,
    [GUILDWAR_BUFF_TYPE["speed"]] = 50,
    [GUILDWAR_BUFF_TYPE["defense"]] = 50,
    [GUILDWAR_BUFF_TYPE["dodge"]] = 50,
    [GUILDWAR_BUFF_TYPE["authority"]] = 50,
}

constants["GUILDWAR_BUFF_FACTOR"] = 
{
    [GUILDWAR_BUFF_TYPE["bp"]] = 0.1,
    [GUILDWAR_BUFF_TYPE["speed"]] = 20,
    [GUILDWAR_BUFF_TYPE["defense"]] = 20,
    [GUILDWAR_BUFF_TYPE["dodge"]] = 20,
    [GUILDWAR_BUFF_TYPE["authority"]] = 10,
}

local GUILD_GRADE = channel_constants["GUILD_GRADE"]
constants["GUILD_PERMISSION_LIST"] = 
{
    ["dismiss"] = { [GUILD_GRADE["chairman"]] = true},
    ["fire"] = { [GUILD_GRADE["chairman"]] = true, [GUILD_GRADE["highstaff"]] = true},
    ["transfer"] = { [GUILD_GRADE["chairman"]] = true },
    ["appoint"] = { [GUILD_GRADE["chairman"]] = true },
    ["set_conf"] = { [GUILD_GRADE["chairman"]] = true, [GUILD_GRADE["highstaff"]] = true},
    ["enter_for_war"] = { [GUILD_GRADE["chairman"]] = true, [GUILD_GRADE["highstaff"]] = true},
    ["buy_buff"] = { [GUILD_GRADE["chairman"]] = true, [GUILD_GRADE["highstaff"]] = true},
    ["update_warfield"] = { [GUILD_GRADE["chairman"]] = true, [GUILD_GRADE["highstaff"]] = true},
}

constants["SCOUT_GUILD_RIVAL_COST"] = 200

constants["GUILDWAR_RANK_BONUS_MAP"] = {2400,2100,1900,1700,1550,1550,1450,1450,1350,1350,1250,1250,1250,1250,1250,1200,1200,1200,1200,1200,1150,1150,1150,1150,1150}

--符文背包初始等级
constants["RUNE_BAG_LEVEL_INIT"] = 1

--符文背包最大容量
constants["MAX_RUNE_BAG_CAPACITY"] = 100
...
constants["GUILD_BOSS_FRIGHT_CONSUME"] = 1 --攻击boss消耗
constants["GUILD_BOSS_BUY_TICKET_LIMIT"] = 1000

constants["SERVER_PVP_BUY_TIMES_COST"] = 200    --跨服PVP购买挑战次数消耗

constants["MAX_ARTIFACT_LEVEL"] = 15   --宝具升级最大等级

--pvp
constants["PVP_MAX_NUM"] = 10           --恢复上限
constants["PVP_IS_BUY"] = true          --是否可购买
constants["PVP_RECOVER_CD"] = 300       --恢复时间(s)，小于等于0表示不能回复
constants["MAX_PVP_RANK"] = 5000
constants["TOP_PVP_RANK"] = 100
constants["PVP_MAX_BUY_TIMES"] = 5

--解锁矿山消耗
constants["MINE_UNLOCK_COST"] = {
    [1] = {},
    [2] = {"soul_chip", -6000,},
    [3] = {"blood_diamond", -5000,},
}

constants["MINE_REWARD_DELAY_TIME"] = 1200 --矿山发放奖励间隔时间
constants["MINE_REFRESH_REWARD_COST"] = 50  --矿山奖励刷新

--矿山默认掠夺次数
constants["DEFAULT_MINE_ROB_TIMES"] = 3

--矿山默认刷新掠夺目标次数
constants["DEFAULT_MINE_REFRESH_TARGET_TIMES"] = 3

--矿山每日免费刷新奖励次数
constants["MINE_REFRESH_REWARD_FREE_TIMES"] = 3

constants["MINE_REFRESH_REPORT_TIMES"] = 15      --获取战报间隔时间

constants["CHECK_MINE_REPORT_DELAY_TIME"] = 15   --检查战报绿点间隔时间

constants["MINE_BE_ROBBED_MAX_TIMES"] = 3    --最大可以掠夺和偷窃的次数

constants["SHARE_TIMES"] = 10             --分享的最大次数

constants["SHARE_REWARD_MAX_COUNT"] = 20             --分享的最大次数

constants["SHAR_MAX_CLICK"] = 10              --最大点击次数

constants["EXPEDITION_TYPE"]=
{
    ["challenge"] = 1,
    ["search"] = 2
}
...
--天梯开始的前置条件为11把宿命武器
constants["LADDER_OPEN_NEED_WEAPON_NUM"]= 11

--终极宿命武器开启需要的星数
constants["FINAL_DESTINY_WEAPON_NEED_STAR_NUM"] = 55
constants["DESTINY_WEAPON_MAX_STAR_LEVEL"] = 12

constants["FLASH_LEADER_TEMPLENT_ID"]= 98000000
constants["SKIN_LEADER_TEMPLENT_ID"] = 97000000
constants["NORMAL_LEADER_TEMPLENT_ID"] = 99000000

constants["CHAT_NEED_ADVENTURE_ID"] = 100003

constants["RESOURCE_RECYCLE_FRESH_TIME"]  = 60

--虚空大冒险
constants["VANITY_STORE_TYPE"] = {
    ["resource"] = 1,
    ["item"] = 2,
}
--召唤cd花费
constants["RECURIT_LIBRAY_TIME_SETTING"] = {
    ["cost"] = 9,     ----x 分钟等于1血钻
}

constants["VANITY_MAZE_STATE"] = {
    ["unlock"] = 1;
    ["challenge_able"] = 2;
    ["challenge_success"] = 3;
    ["maze_finish"] = 4;
...
constants["VANITY_TROOP_MAX"] = 100
--购买一次战斗次数所需要的血钻数量
constants["VANITY_BATTLE_NUM_BLOOD_UNIT"] = 100

--最大关卡数量
constants["VANITY_MAX_MAZE_ID"] = 6 
