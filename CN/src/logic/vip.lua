...
--激活冒险月卡
function vip:ActivateAdventurer(duration,extern)
    if not duration then
        duration = (30 + extern) * 86400
    end
...
function vip:GetMonthCardPrice()
    local month_card_info = payment_logic:GetProductInfo(100)
    return month_card_info and month_card_info.price or ""
end
