...
function campaign_buff_msgbox:UpdateTroopProperty()
    self.formation_name_text:setString(troop_logic:GetFormationName())

    local speed, authority, dodge, defense = troop_logic:GetTroopProperty(troop_logic:GetCurFormationId())
