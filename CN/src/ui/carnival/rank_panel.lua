...
function rank_panel:LoadVote(index)
    ...
    if info.cur_value_multi[3] == 0 then
        ...
        self.desc_text:setString(string.format(lang_constants:Get("carnival_vote_desc2"), carnival_logic:GetLocaleInfoString(token_conf, "name"), vote_rank_info.votes, quality_str))
