...
local ARIL_ROLE_IMG_ID = "11000031"
local MONKEY_ROLE_IMG_ID = "18000037"
local ALAN_ROLE_IMG_ID = "19000059"
local TONITONI_ROLE_IMG_ID = "19000091"
local ZHANGFEI_ROLE_IMG_ID = "19000060"
local PIZZA_ROLE_IMG_ID = "19000092"
local ZHAOZILONG_ROLE_IMG_ID = "18000001"
local CHACHA_ROLE_IMG_ID = "17000010"
local ROLE_CONFIG = {
...
function yearbook_panel:Init(root_node)
    ...
    for k, v in pairs(ROLE_CONFIG) do
        ...
        if temp_img then
            temp_img:ignoreContentAdaptWithSize(true)
