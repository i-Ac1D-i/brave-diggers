...
function vip_panel:Init()
    ...
    if channel.meta_channel == "txwy_dny" then
        ...
        if locale == "en-US" then
            local text1 = scroll_view:getChildByName("line"):getChildByName("difficulty")
            text1:setContentSize(cc.size(text1:getContentSize().width,text1:getContentSize().height + 5))
            local text2 = scroll_view:getChildByName("line2"):getChildByName("difficulty")
            text2:setContentSize(cc.size(text2:getContentSize().width,text2:getContentSize().height + 5))
        end
    end
end
