...
local rune_bag_sub_scene = sub_scene.New()

function rune_bag_sub_scene:Init()
    ...
    self.root_node:registerScriptHandler(function(event)
        if event == "enter" then
            self.ui_root = require "ui.rune_bag_panel"
            self.ui_root:Init()
            self.ui_root:Hide()
...
function rune_bag_sub_scene:Show(...)
    self.root_node:setVisible(true)
    self.ui_root:Show(...)
end

function rune_bag_sub_scene:Hide()
    self.root_node:setVisible(false)
    self.ui_root:Hide()
end

function rune_bag_sub_scene:Update(elapsed_time)
    self.ui_root:Update(elapsed_time)
end

return rune_bag_sub_scene
