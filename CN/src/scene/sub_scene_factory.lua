...
local SUB_SCENE_MAP =
{
    ...
    ["mercenary_vanity_choose_sub_scene"] = { PIPELINE_B, "mercenary_vanity_choose_panel", true },
    ...
    ["mercenary_cultivation_sub_scene"] = { PIPELINE_A, "cultivation_panel", true },
    ...
    ["mine_sub_scene"] = { PIPELINE_C },
    ["mine_report_sub_scene"] = { PIPELINE_C },
    ["carnival_exchange_sub_scene"] = { PIPELINE_C },
    ["share_sub_scene"] = { PIPELINE_C },
    ["ladder_tournament_sub_scene"] = { PIPELINE_C },
    ["evolution_sub_scene"] = { PIPELINE_C },
    ["resource_recycle_sub_scene"] = { PIPELINE_C },
    ["rune_exchange_sub_scene"] = { PIPELINE_C },
    ["vanity_adventure_sub_scene"] = { PIPELINE_C },
    ["vanity_main_sub_scene"] = { PIPELINE_C },
    

    ["server_pvp_sub_scene"] = { PIPELINE_B, "server_pvp_panel", true },
    
    ["guild_boss_sub_scene"] = { PIPELINE_B, "guild.boss_panel", true },
    ["guild_member_sub_scene"] = { PIPELINE_B, "guild.member_panel", true },

    ["magic_shop_sub_scene"] = { PIPELINE_B, "magic_shop_pannel", true },

    ["destiny_weapon_star_sub_scene"] = { PIPELINE_B, "destiny_weapon_star_panel", true },
}
