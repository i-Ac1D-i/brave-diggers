...
return function(novice_sub_scene)
    ...
    novice_sub_scene:AddGroup(6, solve_event_cond.New(1000013),
        ...
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 439 , y = 650 , width = 343 , height = 170 , padding = 20 },
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_enter", is_loop = false,  mercenary_id = 19000041 },
        ...
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7 , x = 152 , y = 618 , width = 200 , height = 70 , padding = 20 },
            { type =  NOVICE_TYPE["text"], content_id = 108,  x = 152, y = 372, width = 100, height = 100 },
            { type =  NOVICE_TYPE["animation"], animation_name = "gesture_loop", is_loop = true , x = 152 , y = 512 , rotation = 90 },
        },
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 37 , y = 171 , width = 250 , height = 90 , padding = 20 },
            { type = NOVICE_TYPE["sim_touch"], x = 152, y = 618},
    ...
    novice_sub_scene:AddGroup(8, solve_event_cond.New(1000018),
        ...
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 320 , y = 238 , width = 250 , height = 90 , padding = 20 },
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_exit", is_loop = false,  mercenary_id = 19000060  },
        ...
        },
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 320 , y = 572 , width = 618 , height = 627 , padding = 20 },
            { type = NOVICE_TYPE["sim_touch"], x = 320, y = 238},
    ...
    novice_sub_scene:AddGroup(10, solve_event_cond.New(1000020),
        ...
        },
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7 , x = 46 , y = 873 , width = 200 , height = 100 , padding = 20 },
            { type =  NOVICE_TYPE["text"], content_id = 161,  x = 46, y = 623, width = 100, height = 100 },
    ...
    novice_sub_scene:AddGroup(13, solve_event_cond.New(1000030),
        ...
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 320 , y = 626 , width = 587 , height = 163 , padding = 20 },
            { type = NOVICE_TYPE["sim_touch"], x = 372, y = 53},
        },
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7 , x = 320 , y = 626 , width = 587 , height = 163 , padding = 20 },
            { type =  NOVICE_TYPE["text"], content_id = 183,  x = 320, y = 376, width = 100, height = 100 },
            { type =  NOVICE_TYPE["animation"], animation_name = "gesture_loop", is_loop = true , x = 320 , y = 526 , rotation = 90 },
        },
        {
            auto_play_next_step = true,
    ...
    novice_sub_scene:AddGroup(31, solve_event_cond.New(1000320),
        ...
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7 , x = 320 , y = 850 , width = 560 , height = 150 , padding = 20 },
            { type =  NOVICE_TYPE["text"], content_id = 275,  x = 320, y = 588, width = 100, height = 100 },
            { type =  NOVICE_TYPE["animation"], animation_name = "gesture_loop", is_loop = true , x = 320 , y = 810 , rotation = 90 },
        },
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 , x = 320 , y = 850 , width = 560 , height = 150 , padding = 20 },
            { type = NOVICE_TYPE["sim_touch"], x = 320, y = 850},
    ...
    --称号系统功能
    novice_sub_scene:AddGroup(32, solve_event_cond.New(1000035),
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0 },
        },
        ...
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7,x = 170 , y = 880 , width = 124 , height = 124 , padding = 20},
            { type =  NOVICE_TYPE["open_sub_scene"],  name = "main_sub_scene"}, 
            { type =  NOVICE_TYPE["animation"], animation_name = "gesture_loop", is_loop = true , x = 180 , y = 750 , rotation = 90 },
        },
        --点击成就按钮
        {
            auto_play_next_step = true,
            mask_info = {alpha = 0.7},
            { type = NOVICE_TYPE["sim_touch"], x = 171, y = 888 },
            { type = NOVICE_TYPE["sim_touch"], x = 210 , y = 903},
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_enter", is_loop = false,  mercenary_id = 18000019  },
        },  
        --显示文本
        {
            ...
            mask_info = { alpha = 0.7 },
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_talk", is_loop = false,  mercenary_id = 18000019  },
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_enter", is_loop = false, content_id = 283 },
        },
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7},
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_loop", is_loop = true, content_id = 283 },
        },
        --显示文本
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 },
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_talk", is_loop = false,  mercenary_id = 18000019  },
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_enter", is_loop = false, content_id = 284 },
        },
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7},
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_loop", is_loop = true, content_id = 284 },
        },
         --显示文本
        {
            auto_play_next_step = true,
            mask_info = { alpha = 0.7 },
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_talk", is_loop = false,  mercenary_id = 18000019  },
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_enter", is_loop = false, content_id = 285 },
        },
        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7,x = 545 , y = 632 , width = 120 , height = 150 , padding = 10},
            { type =  NOVICE_TYPE["animation"], animation_name = "gesture_loop", is_loop = true , x = 550 , y = 480 , rotation = 90 },
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_loop", is_loop = true, content_id = 285 }, 
        },

        {
            auto_play_next_step = false,
            mask_info = { alpha = 0.7},
            { type = NOVICE_TYPE["sim_touch"], x = 550 , y = 635},
            { type =  NOVICE_TYPE["talker"],  animation_name = "talker_enter", is_loop = false,  mercenary_id = 18000019  },
            { type =  NOVICE_TYPE["dialogue"],  animation_name = "dialogue_enter", is_loop = false, content_id = 286 },
        }
    )
end