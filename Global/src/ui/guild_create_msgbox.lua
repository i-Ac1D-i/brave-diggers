...
local guild_create_msgbox = panel_prototype.New(true)
function guild_create_msgbox:Init()
...
function guild_create_msgbox:RegisterWidgetEvent()
    panel_util:RegisterCloseMsgbox(self.root_node:getChildByName("close_btn"), "guild_create_msgbox")
    panel_util:RegisterCloseMsgbox(self.root_node:getChildByName("canel_btn"), "guild_create_msgbox")
