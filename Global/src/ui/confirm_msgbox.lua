...
function RecruitMsgBox:Show(recruit_type)
    ...
    if recruit_type == "ten_mercenary_door" then
        ...
        panel_util:LoadCostResourceInfo(recruit_param, self.item_sub_panels, SUB_PANEL_Y, MAX_SUB_PANEL_NUM)
...
function UnlockProjectSlotMsgBox:Show()
    ...
    panel_util:LoadCostResourceInfo(unlock_project_param, self.item_sub_panels, SUB_PANEL_Y, MAX_SUB_PANEL_NUM)
end
