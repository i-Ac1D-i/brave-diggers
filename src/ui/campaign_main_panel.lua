...
function campaign_main_panel:SetTowerLevelInfo(data)
    ...
    --new单词居中显示
    if platform_manager:GetChannelInfo().campaign_main_panel_level_widget_new_text_ap_center then
        new_text:setAnchorPoint({x=0.5,y=0.5})
        new_text:setPositionX(level_widget:getContentSize().width/2)
    end
