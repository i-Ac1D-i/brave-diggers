...
local guild_notice_panel = panel_prototype.New(true)
function guild_notice_panel:Init()
...
function guild_notice_panel:CreateSubPanels()
...
function guild_notice_panel:Show()
    self.root_node:setVisible(true)
    ...
    self.select_chk:setSelected(guild_logic.is_notice_notifiy)

end

function guild_notice_panel:LoadNoticeInfo()
...
function guild_notice_panel:SetHeadSubPanel(index)
...
function guild_notice_panel:RegisterWidgetEvent()
    panel_util:RegisterCloseMsgbox(self.deal_invitation_msgbox:getChildByName("close_btn"), "guild_notice_panel")
