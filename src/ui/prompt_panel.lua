...
function prompt_panel:Show(prompt_id, ...)
    ...
    local text_height = self.root_node:getVirtualRenderer():getStringNumLines() * 36 + 55 + extern_height
    print(self.root_node:getVirtualRenderer():getStringNumLines(), text_height)
