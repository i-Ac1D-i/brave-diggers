...
function escort_main_panel:Init(root_node)
    ...
    local rob_times_node = self.root_node:getChildByName("intercept_times")
    self.remain_rob_times_text = rob_times_node:getChildByName("value1")
    self.add_rob_times_btn = rob_times_node:getChildByName("add_area_btn")
