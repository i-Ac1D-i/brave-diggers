...
function language_constants:Init(locale)
    ...
    self.LOCALE_STR = {['zh-CN'] = "简体中文", ['en-US'] = "English", ['zh-TW'] = "繁体中文"}
end
...
function language_constants:GetCampaignCond(type, value)
    return self.CAMPAIGN_COND_TYPE[type].."  "..self.campaign_cond[type][value]
end
